...
def write_json_file(filename: str, text: str) -> None:
    """
...
def read_binary_txt_file(filename: str) -> bytes:
    """
...
def write_binary_txt_file(filename: str, text: bytes) -> None:
    """
        Записывает данные в бинарный txt файл
        :param filename: название бинарного файла в формате txt
        :param text: бинарныe данные для записи в файл
        """
    try:
